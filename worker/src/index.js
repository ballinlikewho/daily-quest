...
━━━ TONE ENFORCEMENT ━━━
The tone defined above is not a suggestion. It is the narrative voice of every single sentence in this quest — the opening, every choice, every outcome, every ending. Do not default to generic serious fantasy narration. If the tone is Chaotic Absurdist, the narrator is unhinged and fourth-wall-aware from the first word to the last. If the tone is Grim Dark, every victory feels hollow and nobody is purely heroic. If the tone is High Drama, every moment carries weight and dread. Read the tone description again before writing a single word. Then commit to it completely.
...
- npc: one person with a name, one vivid physical or behavioral detail, and a specific urgent need. Not a type — a person. "Maret Dunn, a fence with ink-stained fingers and a debt she can't pay" not "a mysterious merchant." Name any secondary characters (buyers, guards, antagonists) here too — they must be named in the opening and cannot appear unnamed mid-quest.
...
Before writing a single choice or outcome, internalize the dramatic function of each scene. Each scene has one job. Not "stuff happens" — a specific transformation occurs. Read each scene's function carefully before committing to your story arc.

Scene 1 — THE HOOK (Dramatic function: ESTABLISH THE WANT)
The player enters the situation with a clear goal and an immediate obstacle blocking it. Plant 2-3 specific sensory or physical details here — a smell, an object, a sound, a person's habit — that will echo through later turns and pay off in Turn 5. The player knows what they want. They don't yet know what it will cost.

Scene 2 — THE COMPLICATION (Dramatic function: RECONTEXTUALIZE)
Something the player learned or did in Turn 1 leads them here — but a new piece of information changes what they thought they knew. Not just "things got harder." A fact is revealed, a person is not who they seemed, the macguffin is not where it was supposed to be, an ally has a hidden agenda. The player is still moving toward the goal but the map just changed. The best Turn 2 makes the player say "oh — it's actually about that."

Scene 3 — THE CRISIS (Dramatic function: FORCE A SACRIFICE)
The complication from Turn 2 has escalated into a genuine crisis. Something must be given up — time, trust, safety, resources, an ally. The player cannot have everything. They must choose what to sacrifice in order to keep moving. CRITICAL POSSESSION RULE: The player may or may not have the macguffin at this point. Write all three choices assuming they do NOT. The macguffin is something to reach for, fight over, or bargain about — never something already in hand.

Scene 4 — THE COMMITMENT (Dramatic function: CROSS THE THRESHOLD)
The player has made an irreversible decision. There is no going back. The final location is visible, the antagonist or final obstacle is known, and the cost of the next step is clear. Turn 4 is not a filler turn — it is the moment the player commits to their endgame approach. What they do here directly shapes the texture of Turn 5. The choices should feel like different kinds of irreversible bets: go loud, go quiet, go sideways. Each one closes a door. POSSESSION RULE APPLIES: Do not assume the player has the macguffin.

Scene 5 — THE CLIMAX (Dramatic function: PAY EVERYTHING OFF)
This is not another obstacle. This is the moment of absolute commitment where everything planted in Turns 1-4 converges. The sensory details from Turn 1 should echo here. The NPC's defining detail should be present. The macguffin should be named specifically in the scene description. The three choices are not Easy/Normal/Risky — they are three equally valid, dramatically distinct ways to face the same final moment. Each should feel like a different kind of heroism or desperation. POSSESSION RULE APPLIES: Choices must work for a player who dominated every prior turn AND a player who failed every prior turn. Frame around the final situation — the antagonist, the object, the location — never assumed possession.
...

{
  ...
  "turns": [
    ...
    { "turn": 2, "scene": "ONE sentence only. Where is the player. What is the immediate challenge. Nothing more.", "choices": [...] },
    { "turn": 3, "scene": "ONE sentence only. Where is the player. What is the immediate challenge. Nothing more.", "choices": [...] },
    { "turn": 4, "scene": "ONE sentence only. Where is the player. What is the immediate challenge. Nothing more.", "choices": [...] },
    {
      "turn": 5,
      "scene": "ONE sentence only. Where is the player. What is the immediate challenge. Nothing more.",
      "choices": [
